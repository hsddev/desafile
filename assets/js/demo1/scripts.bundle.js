              ...
              .each(function(tdi, td) {
                ...
                if (typeof column !== "undefined") {
                  ...
                  if (typeof column.template !== "undefined") {
                    ...
                    // sanitize using DOMPurify if installed // TODO:
                    if (typeof DOMPurify !== "undefined" && false) {
...
var KTAsideSecondary = (function() {
  ...
  var getContentHeight = function(content) {
    ...
    height =
      parseInt(KTUtil.getViewPort().height) -
      parseInt(KTUtil.actualHeight(head)) -
      60;
  ...
  var initNavs = function() {
    $('#kt_aside_secondary_nav a[data-toggle="tab"]').on("click", function(e) {
      if (
        lastOpenedTab &&
        lastOpenedTab.is($(this)) &&
        $("body").hasClass("kt-aside-secondary--expanded")
      ) {
    ...
    $('#kt_aside_secondary_nav a[data-toggle="tab"]').on(
      "shown.bs.tab",
      function(e) {
  ...
  return {
    init: function() {
      ...
      $("#kt_aside_menu, #kt_header_menu").on(
        "click",
        '.kt-menu__link[href="#"]:not(.kt-menu__toggle)',
        function(e) {
